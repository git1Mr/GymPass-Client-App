...
// // This is the single place that wraps the entire app in providers.
// // Expo Router renders this as the outermost shell around every route.
...
//       router.replace("/(auth)/login");
//     } else if (token && inAuthGroup) {
//       // Signed in but on an auth screen → push to app
//       router.replace("/(tabs)");
//     }
